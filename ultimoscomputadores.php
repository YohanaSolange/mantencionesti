...
<caption><h3><center> Ultimos Computadores regitrados</center></h3></caption>
  ...
  <tbody>
            ...
            $con2 = new DB;
       //  $strConsulta ="SELECT * FROM `computadores`order by idcomputadores desc limit 3";
         $strConsulta = "SELECT * FROM `computadores` inner JOIN usuarios on computadores.Usuarios_id=usuarios.idusuarios order by idcomputadores desc limit 10";
